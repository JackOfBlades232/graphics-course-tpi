...
void WorldRenderer::loadShaders()
{
  etna::create_program(
    "simple_material",
    SHADOWMAP_SLANG_SLANG_SHADERS_ROOT "simple.slang-vertexMain-fragmentMain.escb");
  etna::create_program(
    "simple_shadow", SHADOWMAP_SLANG_SLANG_SHADERS_ROOT "simple.slang-vertexMain.escb");
}

void WorldRenderer::setupPipelines(vk::Format swapchain_format)
{
  quadRenderer =
    std::make_unique<QuadRenderer>(QuadRenderer::CreateInfo{.format = swapchain_format});
  ...
  vk::CommandBuffer cmd_buf, vk::Image target_image, vk::ImageView target_image_view)
{
  ...
  {
    quadRenderer->render(
      cmd_buf, target_image, target_image_view, {{0, 0}, {512, 512}}, shadowMap, defaultSampler);
  }
}
