...
void FXAAAntialiaser::allocateResources(glm::uvec2 resolution)
{
  targetResolution = resolution;
}

void FXAAAntialiaser::setupPipelines(vk::Format swapchain_format, DebugDrawersRegistry&)
{
  aa = std::make_unique<PostfxRenderer>(PostfxRenderer::CreateInfo{
    "fxaa",
    RENDER_COMPONENTS_SHADERS_ROOT "fxaa.frag.spv",
    swapchain_format,
    {targetResolution.x, targetResolution.y}});
}

void FXAAAntialiaser::antialias(
